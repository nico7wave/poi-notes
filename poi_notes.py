...
BTN = dict(font=("Bahnschrift", 28, "bold"), relief="raised", bd=4,
           padx=28, pady=16, cursor="hand2")
BTN_SM = dict(font=("Bahnschrift", 24, "bold"), relief="raised", bd=3,
...
class MediaEditor(tk.Toplevel):
    def __init__(self, parent, window_title, subtitle, marker_title, content, media_dir, on_save):
        ...
        tk.Label(self, text=window_title, font=("Bahnschrift", 26, "bold"), fg=SUB_COLOR).pack(pady=(18, 0))
        tk.Label(self, text=subtitle,     font=("Bahnschrift", 20),         fg="#888888").pack(pady=(4, 10))

        title_row = tk.Frame(self)
        title_row.pack(fill="x", padx=20, pady=(0, 10))
        tk.Label(title_row, text="Title:", font=("Bahnschrift", 22, "bold"), width=6, anchor="w").pack(side="left")
        self._title_var = tk.StringVar(value=marker_title)
        tk.Entry(title_row, textvariable=self._title_var,
                 font=("Bahnschrift", 24)).pack(side="left", fill="x", expand=True, ipady=6)
        ...
        self.txt = tk.Text(frm, wrap="word", font=("Bahnschrift", 24), yscrollcommand=sb.set)
...
class POIApp:
    def __init__(self, root, image_path, email="", name="", on_logout=None):
        ...
        self._tab_map_btn = tk.Button(
            tab_bar, text="🗺  Map",
            font=("Bahnschrift", 26, "bold"), fg="white",
        ...
        tk.Label(map_hdr, text="meow", bg="#FFFFFF", fg="#27AE60",
                 font=("Bahnschrift", 20, "bold"), padx=18).pack(side="left", pady=14)
        ...
        tk.Button(dpill, text="◀", command=lambda: self._shift_day(-1),
                  ...
                  font=("Bahnschrift", 13), padx=8, cursor="hand2").pack(side="left", ipady=6)
        self._date_lbl = tk.Label(dpill, text="", bg="#E9F7EF", fg="#145A32",
                                  font=("Bahnschrift", 13, "bold"), width=11, anchor="center")
        ...
        self._time_lbl = tk.Label(tpill, text="", bg="#E9F7EF", fg="#145A32",
                                  font=("Bahnschrift", 13, "bold"), width=6, anchor="center")
        ...
        self.info_lbl = tk.Label(self.bar, anchor="w", padx=8, font=("Bahnschrift", 22))
        ...
        tk.Label(self._profile_view, text="My Profile", bg="#F2F2F7",
                 font=("Bahnschrift", 34, "bold"), pady=14).pack()
        ...
        tk.Label(insta_hdr, text="Instagram", bg="#F2F2F7",
                 font=("Bahnschrift", 24, "bold")).pack(side="left")
        ...
        tk.Label(dorm_row, text="🏠", bg="white",
                 font=("Bahnschrift", 28), padx=12).pack(side="left")
        ...
        tk.Label(self._browse_view,
                 ...
                 bg="#F2F2F7", fg="#666666", font=("Bahnschrift", 20)).pack(pady=(0, 16))
        ...
        tk.Label(self.inbox_panel, text="Inbox", bg="#F2F2F7",
                 font=("Bahnschrift", 36, "bold"), pady=20).pack()
        ...
        tk.Label(self.acct_panel, text="Account", bg="#F2F2F7",
                 font=("Bahnschrift", 34, "bold"), fg="#1A1A1A", pady=20).pack()
        ...
        HoverButton(self.acct_panel, nbg="#F2F2F7", hbg="#FFE8E8",
                    ...
                    text="Log Out", font=("Bahnschrift", 20, "bold"),
    ...
    def _set_tab(self, name):
        ...
        inactive = dict(font=("Bahnschrift", 26), fg="#666666")
        active   = dict(font=("Bahnschrift", 26, "bold"), fg="white")
    ...
    def _swipe_like(self):
        ...
        if _LIKED_YOU_BACK.get(idx, False):
            ...
            self._card_note.config(
                ...
                fg="#C13584", font=("Bahnschrift", 22, "bold"))
            self._pass_btn.config(state="disabled")
    ...
    def _next_after_match(self):
        self._card_note.config(fg="#AAAAAA", font=("Bahnschrift", 20, "italic"))
        self._advance_card()
    ...
    def _build_inbox(self):
        ...
        if not matches:
            tk.Label(self._inbox_list_frame,
                     ...
                     bg="#F2F2F7", fg="#888888",
                     font=("Bahnschrift", 26), justify="center").pack(pady=60)
            return
        ...
        for idx, _ in matches:
            ...
            tk.Label(row, text=f"@{nb['instagram']}", bg="white",
                     font=("Bahnschrift", 28, "bold"), fg="#C13584").pack(anchor="w")
            tk.Label(row, text=nb["dorm"], bg="white",
                     font=("Bahnschrift", 22), fg="#555555").pack(anchor="w")
            tk.Label(row, text="Matched!", bg="white",
                     font=("Bahnschrift", 20, "italic"), fg="#27AE60").pack(anchor="w")
    ...
    def _open_match_detail(self, nb):
        ...
        tk.Label(self._inbox_detail_frame, text=f"@{nb['instagram']}",
                 bg="#F2F2F7", font=("Bahnschrift", 42, "bold"), fg="#C13584").pack()
        tk.Label(self._inbox_detail_frame, text=nb["dorm"],
                 bg="#F2F2F7", font=("Bahnschrift", 28), fg="#444444").pack(pady=(10, 0))
        tk.Label(self._inbox_detail_frame, text="Matched with you",
                 bg="#F2F2F7", font=("Bahnschrift", 22, "italic"), fg="#27AE60").pack(pady=(6, 28))
    ...
    def _open_chat(self, nb):
        ...
        tk.Label(win, text=f"@{nb['instagram']}",
                 font=("Bahnschrift", 28, "bold"), fg="#C13584").pack(pady=(18, 0))
        tk.Label(win, text=nb["dorm"],
                 font=("Bahnschrift", 20), fg="#888888").pack(pady=(4, 12))

        frm = tk.Frame(win)
        frm.pack(fill="both", expand=True, padx=14, pady=4)
        sb = tk.Scrollbar(frm)
        sb.pack(side="right", fill="y")
        chat_log = tk.Text(frm, wrap="word", font=("Bahnschrift", 22),
        ...
        entry = tk.Entry(entry_row, textvariable=msg_var,
                         font=("Bahnschrift", 24), relief="solid", bd=1)
    ...
    def _draw_building(self, i):
        ...
        ids = [
            ...
            self.canvas.create_text(
                (x1 + x2) / 2, (y1 + y2) / 2,
                text=str(i + 1), font=("Bahnschrift", 22, "bold"), fill=color,
            ),
        ]
    ...
    def _draw_sub_poi(self, bld_idx, sub_idx):
        ...
        if title and self._zoom >= ZOOM_LABEL_THRESHOLD:
            txt_id = self.canvas.create_text(
                ...
                font=("Bahnschrift", 16, "bold"), fill="white", anchor="s",
            )
...
class LoginWindow:
    ...
    def _primary_btn(self, parent, text, command, pady_top=20):
        HoverButton(parent, nbg=self.PURPLE, hbg=self.PURPLE_D,
                    text=text, font=("Bahnschrift", 14, "bold"),
    ...
    def _build_login(self):
        ...
        tk.Label(hdr, text="meow", bg=self.HEADER, fg="white",
                 font=("Bahnschrift", 58, "bold")).pack(expand=True, pady=(36, 0))
        tk.Label(hdr, text="campus map · TCNJ", bg=self.HEADER, fg="#A9DFBF",
                 font=("Bahnschrift", 13)).pack(pady=(2, 32))
    ...
    def _build_verify(self):
        ...
        tk.Label(f, text="Check your email", bg=self.BG, fg="#1A1A1A",
                 font=("Bahnschrift", 24, "bold")).pack(anchor="w", pady=(24, 0))
        self._verify_sub = tk.Label(f, text="", bg=self.BG, fg="#888888",
                                    font=("Bahnschrift", 12), wraplength=320, justify="left")
        self._verify_sub.pack(anchor="w", pady=(4, 0))

        tk.Label(f, text="6-DIGIT CODE", bg=self.BG, fg="#999999",
                 font=("Bahnschrift", 10, "bold"), anchor="w").pack(fill="x", pady=(28, 2))
        ...
        code_e = tk.Entry(code_border, textvariable=self._verify_code_var,
                          font=("Bahnschrift", 28, "bold"), width=8,
        ...
        HoverButton(row, nbg=self.BG, hbg="#D5F5E3", nfg=self.PURPLE, hfg=self.PURPLE_D,
                    text="Resend code", font=("Bahnschrift", 12), relief="flat", bd=0,
